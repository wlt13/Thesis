...
Fracture stress values were very similar for all specimens, and the measured values are shown in Table \ref{Fracture_stress}. %in Section \ref{Tensile_results}. 
...
\includegraphics[height=8.3cm]{modulusPredictionSiTable}
\end{table}
\FloatBarrier
...
\newline
2.	Assume 14.3\% of particles show void growth. 
\newline
3.	Shear only. 
\newline
...
\newline
1.	Assume 100\% of particles show debonding and void growth 
\newline
2.	Assume 14.3\% of particles show debonding and void growth
\newline
...
%From the literature, how much does cavitation add? Similarly roughly how much does debonding add? Comment on why these values are so low...
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5.5cm]{Si_5_01}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{Si_15_1}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{Si_max_1_2}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{Si_5_-40}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{Si_5_-80}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{Si_15_-80}
...
%\subsubsection{Quasi-static rate}
%which is the normal one above
%
%\begin{figure}[!htpb]
%\centering
%\includegraphics[height=5cm]{} 
%\caption{ wt\% CSR-modified epoxy specimen tested  rate } \label{}
%\end{figure}
%\FloatBarrier
...
CSR 0.5 wt\%
%\paragraph{CSR 0.5 wt\%}

\begin{figure}[!htpb]
\centering
\includegraphics[height=5cm]{CSR_0_1ms_05} 
...
\begin{figure}[!htpb]
\centering
\includegraphics[height=5cm]{CSR_0_1ms_10} 
...
\begin{figure}[!htpb]
\centering
\includegraphics[height=5cm]{CSR40_0_5} 
...
\begin{figure}[!htpb]
\centering
\includegraphics[height=5cm]{CSR40_5} 
...
\begin{figure}[!htpb]
\centering
\includegraphics[height=5cm]{CSR40_10} 
...
\begin{figure}[!htpb]
\centering
\includegraphics[height=5cm]{CSR80_1} 
...
\begin{figure}[!htpb]
\centering
\includegraphics[height=5cm]{CSR80_5} 
...
\begin{figure}[!htpb]
\centering
\includegraphics[height=5cm]{CSR80_10} 
...
%\paragraph{Silica / CSR hybrid 1 wt\% $\-40 ^oC$}

\begin{figure}[!htpb]
\centering
\includegraphics[height=5cm]{Hybrid_1_40}
\caption{hybrid-modified epoxy 1 wt\% specimen tested at  $\-40 ^oC$}\label{Hybrid_1_40}
\end{figure}
\FloatBarrier

Silica / CSR hybrid 5 wt\% $\-40 ^oC$
%\paragraph{Silica / CSR hybrid 5 wt\% $\-40 ^oC$}

\begin{figure}[!htpb]
\centering
\includegraphics[height=5cm]{Hybrid_5_40}
\caption{hybrid-modified epoxy 5 wt\% specimen tested at  $\-40 ^oC$}\label{Hybrid_5_40}
\end{figure}
\FloatBarrier

Silica / CSR hybrid 10 wt\% $\-40 ^oC$
%\paragraph{Silica / CSR hybrid 10 wt\% $\-40 ^oC$}

\begin{figure}[!htpb]
\centering
\includegraphics[height=5cm]{Hybrid_10_40}
...
%\paragraph{Silica / CSR hybrid 1 wt\% $\-80 ^oC$}
...
%\paragraph{Silica / CSR hybrid 5 wt\% $-80 ^oC$}

\begin{figure}[!htpb]
\centering
\includegraphics[height=5cm]{Hybrid_80_5}
\caption{hybrid-modified epoxy 5 wt\% specimen tested at  $\-80 ^oC$}\label{Hybrid_80_5}
\end{figure}
\FloatBarrier

Silica / CSR hybrid 10 wt\% $-80 ^oC$
%\paragraph{Silica / CSR hybrid 10 wt\% $-80 ^oC$}

\begin{figure}[!htpb]
\centering
\includegraphics[height=5cm]{Hybrid_80_10}
...
%\subsubsection{0.1 m/s}
%
%W210  2 wt\% images were not available due to fracture surfaces of specimens could not be protected under high rate tests. The specimens were too contaminated to be view under SEM. 
%
%%\begin{figure}[!hp]
%%\centering
%%\includegraphics[height=5cm]{W210_}
%%\caption{W210 SEM image} \label{W210_}
%%\end{figure}
%%\FloatBarrier
%
%W210 5 wt\%
...
%\begin{figure}[!hp]
%\centering
%\includegraphics[height=5cm]{W210_402}
%\caption{W210 SEM image} \label{W210_402}
%\end{figure}
%\FloatBarrier
%
%W210 5 wt\%
...
%\begin{figure}[!hp]
%\centering
%\includegraphics[height=5cm]{./newResultsGraphs/W210_406}
%\caption{W210 SEM image} \label{W210_406}
%\end{figure}
%\FloatBarrier
%
%W210 10 wt\%
...
%\begin{figure}[!hp]
%\centering
%\includegraphics[height=5cm]{./newResultsGraphs/W210_507}
%\caption{W210 SEM image} \label{W210_507}
%\end{figure}
%\FloatBarrier
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{./newResultsGraphs/W210_401}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{./newResultsGraphs/W210_405}
...
\begin{figure}[!hp]
 \centering
 \includegraphics[height=5cm]{./newResultsGraphs/W210_304}
...
\begin{figure}[!hp]
 \centering
 \includegraphics[height=5cm]{./newResultsGraphs/W210_311}
...
\begin{figure}[!hp]
 \centering
 \includegraphics[height=5cm]{./newResultsGraphs/W210_309}
...
%\begin{figure}[!hp]
% \centering
% \includegraphics[height=5cm]{./newResultsGraphs/W210_3}
% \caption{} \label{W210_3}
% \end{figure}
% \FloatBarrier 
...
%\begin{figure}[!hp]
% \centering
% \includegraphics[height=5cm]{./newResultsGraphs/W210_314}
% \caption{} \label{W210_314}
% \end{figure}
% \FloatBarrier
%
%Hybrid W210 10 wt\%
...
%\begin{figure}[!hp]
% \centering
% \includegraphics[height=5cm]{./newResultsGraphs/W210_}
% \caption{} \label{W210_}
% \end{figure}
% \FloatBarrier
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{./newResultsGraphs/PESRough_zoom_in}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{./newResultsGraphs/1_m010_contrast}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{./newResultsGraphs/1_m015_contrast}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{./newResultsGraphs/PES_201}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{./newResultsGraphs/PES_204}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{./newResultsGraphs/PESsmallparticles_zoom_in}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{./newResultsGraphs/HyPES_5_5}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{./newResultsGraphs/HyPES_5_2}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{./newResultsGraphs/HyPES_5_2_zoom_in}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{./newResultsGraphs/HyPES_7_6}
...
%\begin{figure}[!hp]
%\centering
%\includegraphics[height=5cm]{./newResultsGraphs/HyPES_6_04}
%\caption{} \label{HyPES_6_04}
%\end{figure}
%\FloatBarrier

\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{./newResultsGraphs/HyPES_6_05}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{./newResultsGraphs/HyPES_6_06}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{./newResultsGraphs/HyPES_m009}
...
\begin{figure}[!hp]
\centering
\includegraphics[height=5cm]{./newResultsGraphs/HyPES_m009_zoom_in}
...
\includegraphics[height=4.7cm]{particles_count_density}
\end{table}
\FloatBarrier
